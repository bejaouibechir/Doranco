...
namespace WpfAppDeconnecté {
    ...
    public partial class AdventureWorksDS : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string Title, string FirstName, string LastName, string CompanyName, string EmailAddress, string Phone) {
...
namespace WpfAppDeconnecté.AdventureWorksDSTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [SalesLT].[Customer] WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ((@IsNull_CompanyName = 1 AND [CompanyName] IS NULL) OR ([CompanyName] = @Original_CompanyName)) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [SalesLT].[Customer] SET [Title] = @Title, [FirstName] = @FirstName, [LastName] = @LastName, [CompanyName] = @CompanyName, [EmailAddress] = @EmailAddress, [Phone] = @Phone WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ((@IsNull_CompanyName = 1 AND [CompanyName] IS NULL) OR ([CompanyName] = @Original_CompanyName)) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT CustomerID, Title, FirstName, LastName, CompanyName, EmailAddress, Phone FROM SalesLT.Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfAppDeconnecté.Properties.Settings.Default.adwconnstring;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        CustomerID, Title, FirstName, LastName, CompanyName, EmailAddress, " +
        ...
        public virtual int Remplir(AdventureWorksDS.CustomerDataTable dataTable) {
        ...
        public virtual AdventureWorksDS.CustomerDataTable Recuperer() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Title, string Original_FirstName, string Original_LastName, string Original_CompanyName, string Original_EmailAddress, string Original_Phone) {
        ...
        public virtual int Update(string Title, string FirstName, string LastName, string CompanyName, string EmailAddress, string Phone, int Original_CustomerID, string Original_Title, string Original_FirstName, string Original_LastName, string Original_CompanyName, string Original_EmailAddress, string Original_Phone, int CustomerID) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string FirstName, string LastName, string CompanyName, string EmailAddress, string Phone, int Original_CustomerID, string Original_Title, string Original_FirstName, string Original_LastName, string Original_CompanyName, string Original_EmailAddress, string Original_Phone) {
            return this.Update(Title, FirstName, LastName, CompanyName, EmailAddress, Phone, Original_CustomerID, Original_Title, Original_FirstName, Original_LastName, Original_CompanyName, Original_EmailAddress, Original_Phone, Original_CustomerID);
        }
    }
