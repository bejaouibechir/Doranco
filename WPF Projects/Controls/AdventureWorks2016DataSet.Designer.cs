...
namespace Controls {
    ...
    public partial class AdventureWorks2016DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(int BusinessEntityID, string PersonType, string Title, string FirstName, string MiddleName, string LastName) {
...
namespace Controls.AdventureWorks2016DataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Person].[Person] ([BusinessEntityID], [PersonType], [Title], [FirstName], [MiddleName], [LastName]) VALUES (@BusinessEntityID, @PersonType, @Title, @FirstName, @MiddleName, @LastName);
SELECT BusinessEntityID, PersonType, Title, FirstName, MiddleName, LastName FROM Person.Person WHERE (BusinessEntityID = @BusinessEntityID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Person].[Person] SET [BusinessEntityID] = @BusinessEntityID, [PersonType] = @PersonType, [Title] = @Title, [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName WHERE (([BusinessEntityID] = @Original_BusinessEntityID) AND ([PersonType] = @Original_PersonType) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_MiddleName = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = @Original_MiddleName)) AND ([LastName] = @Original_LastName));
SELECT BusinessEntityID, PersonType, Title, FirstName, MiddleName, LastName FROM Person.Person WHERE (BusinessEntityID = @BusinessEntityID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Controls.Properties.Settings.Default.AdventureWorks2016ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BusinessEntityID, PersonType, Title, FirstName, MiddleName, LastName FROM " +
                "Person.Person";
        ...
        public virtual int Fill(AdventureWorks2016DataSet.PersonDataTable dataTable) {
        ...
        public virtual AdventureWorks2016DataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorks2016DataSet.PersonDataTable dataTable = new AdventureWorks2016DataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorks2016DataSet.PersonDataTable dataTable) {
        ...
        public virtual int Delete(int Original_BusinessEntityID, string Original_PersonType, string Original_Title, string Original_FirstName, string Original_MiddleName, string Original_LastName) {
        ...
        public virtual int Insert(int BusinessEntityID, string PersonType, string Title, string FirstName, string MiddleName, string LastName) {
        ...
        public virtual int Update(int BusinessEntityID, string PersonType, string Title, string FirstName, string MiddleName, string LastName, int Original_BusinessEntityID, string Original_PersonType, string Original_Title, string Original_FirstName, string Original_MiddleName, string Original_LastName) {
            ...
            if ((Original_PersonType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_PersonType));
            }
            if ((Original_Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PersonType, string Title, string FirstName, string MiddleName, string LastName, int Original_BusinessEntityID, string Original_PersonType, string Original_Title, string Original_FirstName, string Original_MiddleName, string Original_LastName) {
            return this.Update(Original_BusinessEntityID, PersonType, Title, FirstName, MiddleName, LastName, Original_BusinessEntityID, Original_PersonType, Original_Title, Original_FirstName, Original_MiddleName, Original_LastName);
        }
    }
